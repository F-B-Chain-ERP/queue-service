...
class ReportJobDispatcherTest {
    ...
    void testDispatchSuccess() {
        ...
        when(reportJobStateService.claimJob(jobId)).thenReturn(true);
        ...
        verify(reportJobStateService).claimJob(jobId);
    ...
    void testDispatchSkippedWhenClaimFails() {
        ...
        when(reportJobStateService.claimJob(jobId)).thenReturn(false);
